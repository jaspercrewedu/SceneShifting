class Overworld extends Phaser.Scene {
    ...
    create() {
        ...
        this.physics.world.on('worldbounds', (body, blockedUp, blockedDown, blockedLeft, blockedRight) => {
            ...
            else if (blockedRight && this.currentRoom.x <= 1) {
                this.destination = {x:this.currentRoom.x + 1, y:this.currentRoom.y};
            }
            else {
                this.destination = this.currentRoom;
            }
            if (this.destination != this.currentRoom) {

                this.currentRoom = this.destination;
                ...
                this.physics.world.setBounds(this.destination.x * this.ROOMWIDTH - this.player.displayWidth - 1,
                    this.destination.y * this.ROOMHEIGHT - this.player.displayHeight - 1,
                    this.ROOMWIDTH + this.player.displayWidth, this.ROOMHEIGHT + this.player.displayHeight);
            }
